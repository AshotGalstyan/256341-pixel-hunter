    ...
    return `
      <section class="game">
        ...
        <form class="game__content  game__content--triple">
          ...
          <div class="game__option"${(DEBUG ? ` data-type="&nbsp;${this.allImages[this.images[2]].type}&nbsp;"` : ``)}>
            <label>
              ${createImage(this.images[2], `Option 3`, this._place, this.allImages[this.images[2]].size)}
